 ...
 * the streak — including a phone that travels.
 *
 * Pinned rather than read from the device. Changing it re-dates every stored
 * day, so it is a migration, not a setting.
 */
const PINNED_TIMEZONE = 'America/New_York';

export const APP_TIMEZONE = PINNED_TIMEZONE;
